const categories = [
  { name: "Tops", percent: 82 },
  { name: "Bottoms", percent: 68 },
  { name: "Dresses", percent: 54 },
  { name: "Shoes", percent: 46 },
];
...
export default function TopCategories() {
  return (
    <div className="bg-white rounded-3xl border border-[#E8DED2] p-6 shadow-sm">
      ...
      <p className="text-[#9B948B] mb-8">Most used wardrobe categories</p>
        ...
        {categories.map((category) => (
          <div key={category.name}>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-[#9B948B]">{category.percent}%</span>
            </div>
