...
export default function StatCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8DED2] shadow-sm p-6 min-h-[135px] flex flex-col justify-between">
      ...
      <div>
        ...
        <h2 className="text-3xl font-bold text-[#2F3E34]">{value}</h2>
      </div>
    </div>
  );
}