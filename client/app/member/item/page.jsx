...
function getDefaultStyle(category, subcategory) {
  if (subcategory?.includes("Gown")) return "Formal";
  if (subcategory?.includes("Blazer")) return "Business Casual";
  if (category === "Activewear") return "Sporty";
  return "Casual";
}

function getDefaultSeason(category, subcategory) {
  if (["Puffer Jacket", "Wool Coat", "Beanie", "Gloves"].includes(subcategory)) {
    return "Winter";
  }

  if (["Sandals", "Shorts", "Sundress", "Tank Top", "Crop Top"].includes(subcategory)) {
    return "Summer";
  }
...
function getDefaultOccasion(category, subcategory) {
  if (subcategory?.includes("Gown")) return "Formal Event";
  if (category === "Activewear") return "Sport / Gym";
  return "Everyday";
}
...
console.log("🎨 COLOR RESPONSE:", colorData);
    ...
    if (data.success) {
  console.log("✅ Structured AI:", data);
  ...
  setForm((prev) => ({
    ...
    color: data.color || "",
    style: getDefaultStyle(data.category, data.subcategory),
    season: getDefaultSeason(data.category, data.subcategory),
    occasion: getDefaultOccasion(data.category, data.subcategory),
  }));
