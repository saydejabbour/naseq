...
export default function StylistPendingPage() {
    ...
    <div className="min-h-screen bg-[#FDF8F3] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-500 text-sm leading-6 mb-6">
          Your stylist account is pending admin approval. You will be able to
          access the stylist dashboard once your application is approved.
        </p>
